            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'SINNED-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of SINNED'S amazing bot.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Darksinned GitHub Repo](https://github.com/Darksinned/)  

🚀 _Thanks for choosing SINNED-MD — Let the automation begin!_ ✨`;
